...

{
  ...
  '1':: function(abi) (
    if self.map(abi).rampTimes <= 1 then 'after %(value)g or more power flips, '
    else if self.map(abi).value == 1 then 'every power flip, '
    else 'every %(value)g power flips, '
  ) % self.map(abi),
  '2':: function(abi) (
    if self.map(abi).rampTimes <= 1 then 'after %(value)g or more dashes, '
    else if self.map(abi).value == 1 then 'every dash, '
    else 'every %(value)g dashes, '
  ) % self.map(abi),
  '3':: function(abi) (
    if self.map(abi).rampTimes <= 1 then 'after %(value)g or more ball flips, '
    else if self.map(abi).value == 1 then 'every ball flip, '
    else 'every %(value)g ball flips, '
  ) % self.map(abi),
  '4':: function(abi)
  ...
  '6':: function(abi) (
    if self.map(abi).rampTimes <= 1 then 'after defeating %(value)g or more enemies, '
    else if self.map(abi).value == 1 then 'every enemy defeated, '
    else 'every %(value)g enemies defeated, '
  ) % self.map(abi),
  '7':: function(abi) (
    if self.map(abi).rampTimes <= 1 then 'upon reaching %(value)g combo, '
    else 'every %(value)g combo, '
  ) % self.map(abi),
  ...
  '15':: function(abi) (
    if self.map(abi).rampTimes <= 1 then 'after %(value)g or more direct attacks by %(target)s, '
    else if self.map(abi).value == 1 then 'every direct attack by %(target)s, '
  ...
  '21':: function(abi) (
    if self.map(abi).rampTimes <= 1 then 'after %(value)g or more flips, '
    else if self.map(abi).value == 1 then 'every flip, '
    else 'every %(value)g flips, '
  ) % self.map(abi),
  ...
  '58':: function(abi) (
    if self.map(abi).rampTimes <= 1 then 'after %(value)g or more Lv1 power flips, '
    else if self.map(abi).value == 1 then 'every Lv1 power flip, '
    else 'every %(value)g Lv1 power flips, '
  ) % self.map(abi),
  '59':: function(abi) (
    if self.map(abi).rampTimes <= 1 then 'after %(value)g or more Lv2 power flips, '
    else if self.map(abi).value == 1 then 'every Lv2 power flip, '
    else 'every %(value)g Lv2 power flips, '
  ) % self.map(abi),
  '60':: function(abi) (
    if self.map(abi).rampTimes <= 1 then 'after %(value)g or more Lv3 power flips, '
    else if self.map(abi).value == 1 then 'every Lv3 power flip, '
    else 'every %(value)g Lv3 power flips, '
  ) % self.map(abi),
  ...
  '72':: function(abi) (
    ...
    else if self.map(abi).value == 1 then 'every second, '
  ...
  '181':: function(abi) (
    if self.map(abi).rampTimes <= 1 then 'after %(value)g or more consecutive power flips, '
    else if self.map(abi).value == 1 then 'every consecutive power flip, '
    else 'every %(value)g consecutive power flips, '
  ) % self.map(abi),
  ...
  '231':: function(abi) (
    if self.map(abi).rampTimes <= 1 then 'after %(value2)g seconds of float buff, '
    else if self.map(abi).value2 == 1 then 'every second of float buff, '
    else 'every %(value2)g seconds of float buff, '
  ) % self.map(abi, divisor=6000000),
  ...
  '255':: function(abi) (
    if self.map(abi).rampTimes <= 1 then 'after %(value)g or more Lv1 or Lv2 power flips, '
    else if self.map(abi).value == 1 then 'every Lv1 or Lv2 power flip, '
    else 'every %(value)g Lv1 or Lv2 power flips, '
  ) % self.map(abi),
}
